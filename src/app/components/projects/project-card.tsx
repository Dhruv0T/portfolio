...
const ProjectCard = ({ project }: ProjectCardProps) => {
  ...
  const hasNoExternalLinks = !hasDemo && !hasCode;
        ...
        <CardFooter className="p-6 pt-2 flex gap-4">
          {hasNoExternalLinks ? (
            <Link href={`/projects/${project.id}`} className="flex-1">
              <Button className="w-full h-11 rounded-xl text-xs font-bold uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-2 border border-white/10 bg-white/5 hover:bg-red-600 text-white hover:border-red-500 shadow-xl hover:shadow-red-600/20">
