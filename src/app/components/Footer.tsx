  ...
  <footer className="bg-[#050505] border-t border-white/5 text-gray-200">
    <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-24">
        <div className="flex flex-col gap-6">
          ...
          <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
            AI-focused engineering student building practical, high-performance
            software across computer vision, real-time systems, and full-stack
            applications.
          </p>
        </div>
      ...
      <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-gray-500 text-sm">
        <p>
          &copy; {new Date().getFullYear()} Dhruv Torney. All rights reserved.
        </p>
        <p className="flex items-center gap-2">
          Built with <span className="text-red-600 animate-pulse">❤️</span> by
          Dhruv
        </p>
      </div>
    </div>
