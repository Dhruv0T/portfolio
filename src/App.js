  ...
  return (
    <div className="App">
      ...
      <section id="about" className="p-4">
        ...
        <p>Some highlights within my journey include making my first chatbot where I was able to use some data with pre-trained models but also build my own front end for it and make changes in the back end aspect of what I used the data from the chatbot to do and store it for future conversations. I also would like to highlight my Entrepreneurship Project for Computer Science Essentials where I developed a website that helps solve the global issue of Lost and Founds using my knowledge of Python and Flask.</p>
